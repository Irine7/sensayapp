...
// Create function for generating welcome message
...
export default function ChatProvider({ children }: { children: ReactNode }) {
				...
				try {
					...
					setMessages((prev) => [
						...prev,
						{
							...
							role: 'assistant',
							content:
								"I'm currently experiencing connection issues with my knowledge base. Please try again in a moment.",
							timestamp: Date.now(),
						},
					]);
				}
	...
	return (
		<ChatContext.Provider
			value={{ messages, addMessage, isLoading, clearChat }}
		>
			{children}
		</ChatContext.Provider>
	);
