				...
				<div className="text-center space-y-8">
					<div className="space-y-4">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							Окунитесь в будущее ИИ-разговоров с нашим элегантным и современным
							интерфейсом
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
						<div className="card-elegant p-6 text-center space-y-4">
							...
							<h3 className="text-lg font-semibold">ИИ-Разговоры</h3>
							<p className="text-muted-foreground">
								Ведите интеллектуальные разговоры с продвинутыми ИИ-репликами
							</p>
						</div>
						...
						<div className="card-elegant p-6 text-center space-y-4">
							...
							<h3 className="text-lg font-semibold">Чат в реальном времени</h3>
							<p className="text-muted-foreground">
								Наслаждайтесь бесшовным общением в реальном времени с
						...
						<div className="card-elegant p-6 text-center space-y-4">
							...
							<p className="text-muted-foreground">
								Ваши разговоры защищены корпоративным уровнем безопасности
							</p>
						</div>
					</div>
				</div>
