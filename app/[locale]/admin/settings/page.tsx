		...
		>
			<div className="container py-10">
				<h1 className="text-3xl font-bold mb-6">
					API Sensay Settings Management
				</h1>
				...
				<div className="grid gap-8 grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
							...
							<CardContent className="space-y-4">
								...
								<div className="grid gap-2">
									...
									<Input
										...
										onChange={(e) =>
											setNewSetting({ ...newSetting, apiKey: e.target.value })
										}
										required
									/>
								</div>
								...
								<div className="grid gap-2">
									...
									<Input
										...
										onChange={(e) =>
											setNewSetting({ ...newSetting, userId: e.target.value })
										}
										required
									/>
								</div>
								...
								<div className="grid gap-2">
									<Label htmlFor="replicaUuid">
										UUID Replica (SENSAY_REPLICA_UUID)
									</Label>
									<Input
										id="replicaUuid"
								...
								<div className="flex items-center space-x-2">
									<Switch
										...
										onCheckedChange={(checked) =>
											setNewSetting({ ...newSetting, isActive: checked })
										}
									/>
					...
					<Card className="mb-8">
						<CardHeader>
							...
							<CardDescription>List of all saved API settings</CardDescription>
						</CardHeader>
